...
def moving_vertical_left(frame_number, rain_drops, n_drops, scat, arr):
    rain_drops = rain_drops
    n_drops = n_drops
    scat = scat
    index_control = 30
...
def moving_vertical_up(frame_number, rain_drops, n_drops, scat, arr):
    rain_drops = rain_drops
    n_drops = n_drops
    scat = scat
    index_control = 30
    ...
    # Sweep to the Right 
    for count, pixels in enumerate(memory):
        new_list = [x+(count*30) for x in pixels]
        new_memory.append(new_list)
...
def moving_vertical_down(frame_number, rain_drops, n_drops, scat, arr):
    rain_drops = rain_drops
    n_drops = n_drops
    scat = scat
    index_control = 30
